                        ...
                        <Table style={{ width: '100%' }}>
                            <TableBody>
                                <TableRow>
                                    ...
                                    <TableCell align="center" sx={{ border: 1, borderColor: 'grey.500', textAlign: 'center', fontWeight: 'bold', width: '33%' }}>{score.perceivedAge}<br /><span style={{ fontWeight: 'normal' }}>Perceived Age</span></TableCell>
