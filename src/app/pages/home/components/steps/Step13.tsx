    ...
    <div className='w-100 mb-120 container'>
      ...
      <div className='p-0'>
        <div className='age-selection-container'>
          <div className='row g-0 display-flex-row'>
            <div className='col pb-8 rounded-2 display-flex-row'>
              <button
                type='button'
                className={`btn btn-block d-block align-items-center fixed-width ${values.age === 'below18' ? 'selected-btn' : 'btn-outline-primary'}`}
            ...
            <div className='col-auto pb-8 rounded-2'>
              <button
                type='button'
                className={`btn btn-block d-block align-items-center fixed-width ${values.age === '18to24' ? 'selected-btn' : 'btn-outline-primary'}`}
          ...
          <div className='row g-0 display-flex-row'>
            <div className='col pb-8 rounded-2 display-flex-row'>
              <button
                type='button'
                className={`btn btn-block d-block align-items-center fixed-width ${values.age === '25to30' ? 'selected-btn' : 'btn-outline-primary'}`}
                onClick={() => handleButtonClick('25to30')}
              >
                <span className='font-size-20 mb-2 text-center'>25 to 30</span>
              </button>
            </div>
            <div className='col-auto pb-8 rounded-2 display-flex-row'>
              <button
                type='button'
                className={`btn btn-block d-block align-items-center fixed-width ${values.age === '30to34' ? 'selected-btn' : 'btn-outline-primary'}`}
          ...
          <div className='row g-0 display-flex-row'>
            <div className='col pb-8 rounded-2 display-flex-row'>
              <button
                type='button'
                className={`btn btn-block d-block align-items-center fixed-width ${values.age === '34to40' ? 'selected-btn' : 'btn-outline-primary'}`}
            ...
            <div className='col-auto pb-8 rounded-2'>
              <button
                type='button'
                className={`btn btn-block d-block align-items-center fixed-width ${values.age === 'above40' ? 'selected-btn' : 'btn-outline-primary'}`}
